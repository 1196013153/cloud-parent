...
public class MyLoadBalancerAutoConfiguration {
    ...
    @Bean
    public MyClientRequestInterceptor myLoadBalancerInterceptor(LoadBalancerClient loadBalancerClient,
                                                               LoadBalancerRequestFactory requestFactory) {
        return new MyClientRequestInterceptor(loadBalancerClient,requestFactory);
    }
